...
def data():
    try:
        ...
        for airline in airlines:
            sql_select_positive = "SELECT airline,count(sentiment) from details where sentiment='positive' and airline='%s'" %(airline)
            sql_select_negative = "SELECT airline,count(sentiment) from details where sentiment='negative' and airline='%s'" %(airline)
            sql_select_neutral = "SELECT airline,count(sentiment) from details where sentiment='neutral' and airline='%s'" %(airline)
        ...
        aspects = ['Ground Service','Inflight Entertainement','Legroom', 'Value For Money', 'Food & Beverage', 'Cabin Staff Service']
        vis=[]
        for airline in airlines:
            visual= []
            for aspect in aspects:
                sql_aspects = "SELECT count(aspect) from details where aspect='%s' and airline='%s' " %(aspect,airline)
